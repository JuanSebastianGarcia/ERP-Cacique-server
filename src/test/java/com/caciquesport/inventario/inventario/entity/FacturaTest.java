...
public class FacturaTest {
    ...
    public void generarFactura() throws Exception {
        ...
        FacturaDto facturaDto = new FacturaDto(0,"", "1234567890", listaProductos, "EFECTIVO", 60000,0);
    ...
    public void guardarCambiosFactura() throws Exception {
        ...
        FacturaDto facturaDto = new FacturaDto(facturaEncontrada.idFactura(),facturaEncontrada.estadoFactura(), "1234567890", listaProductos, "EFECTIVO", 0,0);
